# Experiment Log: 20260311_0053_base_experiment
...
## 3. 回测性能指标
- **Seed_10_夏普比率**: 0.2279 (回撤: 24.36%) 
- **Seed_20_夏普比率**: 0.8034 (回撤: 16.81%) 
- **Seed_30_夏普比率**: 0.0415 (回撤: 30.64%) 
- **Seed_40_夏普比率**: -0.2038 (回撤: 20.10%) 
- **Seed_50_夏普比率**: 0.3189 (回撤: 19.96%) 
- **Seed_60_夏普比率**: 0.2977 (回撤: 25.36%) 
- **Seed_70_夏普比率**: 0.4576 (回撤: 16.49%) ⭐ (本轮代表)
- **Seed_80_夏普比率**: 0.7199 (回撤: 13.65%) 
- **Seed_90_夏普比率**: 0.7765 (回撤: 17.61%) 
- **Seed_100_夏普比率**: 0.8432 (回撤: 17.37%) 
- **---**: ---
- **汇总_RL_平均夏普**: 0.4283 ± 0.3374
- **汇总_RL_平均最大回撤**: 20.24%
- **汇总_选取基准模型**: Seed 70 (夏普 0.4576，最接近均值)
