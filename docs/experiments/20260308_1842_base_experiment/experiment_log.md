# Experiment Log: 20260308_1842_base_experiment
...
## 3. 回测性能指标
- **Seed_10_夏普比率**: 0.4276 (回撤: 22.84%, 耗时: 1.40m)
- **Seed_20_夏普比率**: 0.9966 (回撤: 20.11%, 耗时: 1.37m)
- **Seed_30_夏普比率**: 0.6067 (回撤: 18.64%, 耗时: 1.35m)
- **Seed_40_夏普比率**: 0.7976 (回撤: 15.87%, 耗时: 1.38m)
- **Seed_50_夏普比率**: 0.5370 (回撤: 21.36%, 耗时: 1.31m)
- **Seed_60_夏普比率**: 0.8751 (回撤: 20.84%, 耗时: 1.30m)
- **Seed_70_夏普比率**: 0.5497 (回撤: 22.30%, 耗时: 1.30m)
- **Seed_80_夏普比率**: 0.4399 (回撤: 21.03%, 耗时: 1.31m)
- **Seed_90_夏普比率**: -0.2353 (回撤: 25.86%, 耗时: 1.31m)
- **Seed_100_夏普比率**: 0.7655 (回撤: 17.06%, 耗时: 1.29m)
- **---**: ---
- **汇总_RL_平均夏普**: 0.5760 ± 0.3245
- **汇总_RL_平均最大回撤**: 20.59%
- **汇总_最佳夏普记录**: 0.9966 (保存在 checkponts 目录)
